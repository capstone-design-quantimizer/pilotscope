...
def training_pairwise_pilot_score(lero_model, X1, X2, num_epoch, mlflow_tracker=None):
    ...
    lero_model.fit(X1, X2, Y1, Y2, tuning_model, num_epoch, mlflow_tracker=mlflow_tracker)
